...
-- Listage des données de la table footballclub.club : ~0 rows (environ)
...
-- Listage des données de la table footballclub.clubs : ~0 rows (environ)
...
-- Listage des données de la table footballclub.country : ~0 rows (environ)
...
-- Listage des données de la table footballclub.effectif : ~0 rows (environ)
...
-- Listage des données de la table footballclub.league : ~0 rows (environ)
...
-- Listage des données de la table footballclub.user : ~0 rows (environ)
